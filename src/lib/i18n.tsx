...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'skills.progress': '{earned} of {total} skills earned',
    'skills.max_rate': 'Max ${rate}/hr',
  ...
  es: {
    ...
    'skills.progress': '{earned} de {total} habilidades ganadas',
    'skills.max_rate': 'Máx ${rate}/hr',
    'skills.base_rate': 'Base ${rate}/hr',
